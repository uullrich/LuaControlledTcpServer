...
private:
  ...
  void stopServer();
  std::string createCanMessage(uint32_t id, const sol::table &data,
                               bool extended, bool rtr);
  bool sendCanMessage(const std::string &clientId,
  ...
  void onMessageReceived(const std::string &clientId,
